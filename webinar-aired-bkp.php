...
?>
    ...
    <header class="page-header d-none">
     ...
     <header class="container-fluid d-flex align-items-center justify-content-center text-center bg-light hero-section">
        <div>
            <h1 class="display-3 fw-800 animate__animated animate__fadeInDown"><span style="color: var(--primary-teal);">Webinars </span> Aired</h1>
            <p class="lead mb-4 animate__animated animate__fadeInUp animate__delay-1s">Explore previously conducted webinars, learn from expert sessions, and revisit key market insights anytime.</p>
