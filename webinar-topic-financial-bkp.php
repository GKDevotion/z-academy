...
?>
     ...
     <header class="container-fluid d-flex align-items-center justify-content-center text-center bg-light hero-section">
        <div>
            <h1 class="display-3 fw-800 animate__animated animate__fadeInDown">Webinar<span style="color: var(--primary-teal);">  Financial</span> </h1>
            <p class="lead mb-4 animate__animated animate__fadeInUp animate__delay-1s">Gain practical knowledge and real-world insights from expert-led financial webinars covering trading, investing, and global markets.</p>
