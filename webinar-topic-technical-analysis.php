...
?>
     ...
     <header class="container-fluid d-flex align-items-center justify-content-center text-center bg-light hero-section">
        <div>
            <h1 class="display-3 fw-800 animate__animated animate__fadeInDown">Technical<span style="color: var(--primary-teal);">Analysis</span> </h1>
            <p class="lead mb-4 animate__animated animate__fadeInUp animate__delay-1s">Master chart reading, indicators, and price action strategies to improve trading accuracy and decision-making.</p>
